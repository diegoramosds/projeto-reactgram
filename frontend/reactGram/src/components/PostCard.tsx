...
const PostCard = ({ photo, isPhotoDetail }: PostCardProps) => {
  ...
  return (
    <div>
      <div
        className="bg-zinc-900/30 w-[95%]  min-h-[500px] mx-auto mt-14 mb-16 rounded-xl shadow-md border border-zinc-900
            flex flex-col justify-between md:w-[65%] md:min-h-[680px]"
      >
        ...
        {!isPhotoDetail && (
          <Link to={`/photos/${photo._id}`}>
            <p className="text-center p-3 bg-zinc-900/70 text-sm hover:bg-zinc-900/74 hover:text-zinc-300 rounded-b-xl">
              Veja detalhes
            </p>
          </Link>
        )}
