  ...
  return (
    <div className="md:w-2/3 mx-auto mt-2">
      <div className="flex flex-col gap-3 items-center">
        ...
        <div className="flex gap-3 flex-col items-center justify-center break-words">
          <h2 className="text-2xl font-medium">{user?.name}</h2>
          <p className="text-base text-zinc-400 break-words w-2/3 mx-auto text-center">
            {user?.bio}
          </p>
        </div>
      ...
      <div className="flex flex-col">
        <div className="border-t border-b border-zinc-900 p-3">
          <h2 className="flex items-center gap-1 justify-center text-lg w-1/6 mx-auto border-b-[3px] p-1">
            <BiGrid />
            Publicações
          </h2>
        </div>
